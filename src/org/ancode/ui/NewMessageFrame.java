...
public class NewMessageFrame extends JFrame {
    ...
    private void initComponents() {
        ...
        btnNewMessage.setIcon(new javax.swing.ImageIcon(getClass().getResource("/res/images/icon/minilogo.png"))); // NOI18N
        btnNewMessage.setToolTipText("������");
    ...
    public void addMessagePrompt(final List<Message> msgList) throws Exception {
        ...
        if (btnPrompt != null) {
            btnPrompt.setToolTipText(name + ":" + msgList.size() + " ������������");
            return;
        } else {
            btnPrompt = new JButton();
            btnPrompt.setToolTipText(1 + " ������������");
