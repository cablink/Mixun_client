...
import org.ancode.util.GroupUtil;
...
//            msg.add(text);
            ...
            json.put("psessionid", Auth.getPsessionid());
            ...
            String res = httpService.sendHttpMessage();
